        ...
        <section className="background-image-home">
          <div className="container">
            ...
            >
              ...
              <div className="col-md-5 text-wrapper">
                <h1>Hi, I'am Diva</h1>
                <h4>Software Developer</h4>
                <p>
                  Switching careers to software developer.<br></br>I just
                  graduated from Binar Academy Bootcamp.<br></br>When i decided
                  to be a software developer,<br></br>it means i'am ready to be
                  a long life learner
                </p>
                <p>
                  <ImLocation2 /> Badung, Bali, Indonesia
                </p>
                <div className="d-flex button-home-wrapper">
                  <Link
                    to={"/about-me"}
